...
def get_life_expectancy(
    age: int, life_expectancy_table: dict[int, float]
) -> float | None:
    try:
        user_age: int = 119 if age >= 119 else age
        table: dict[int, float] = life_expectancy_table
        life_expectancy: float = table[user_age]
...
def main():
    ...
    if gender == "male":
        ...
        life_expectancy = get_life_expectancy(
            customer_age, life_expectancy_table_female
        )
